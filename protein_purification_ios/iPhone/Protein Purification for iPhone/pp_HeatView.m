...
- (void)drawRect:(CGRect)rect
{
    ...
    [self drawButton:CGRectMake(10, 36, 220, 140)];
    
        
    if (!heatHeader)
    {
            heatHeader = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, 200, 21)];
        ...
        heatHeader.frame = CGRectMake(20, 10, 200, 21);
        
    if (!heatLabel)
    {
            heatLabel = [[UILabel alloc] initWithFrame:CGRectMake(25, 42, 200, 21)];
        ...
        heatLabel.frame = CGRectMake(25, 42, 200, 21);
        
    
    if (!heatPicker)
    {
        heatPicker = [[CPPickerView alloc] initWithFrame:CGRectMake(192, 6, 112, 30)];
    ...
    heatPicker.center = CGPointMake(155,83);
    ...
    dividerButton.frame = CGRectMake(11, 106, 218, 2);
    
    if (!timeLabel)
    {
        timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(25, 110, 200, 21)];
        ...
        timeLabel.frame = CGRectMake(25, 110, 200, 21);
    ...
    timePicker.center = CGPointMake(155,151);
    
    self.timeFloatValue = 10.0;
    
    if (!helpHeader)
    {
        helpHeader = [[UILabel alloc] initWithFrame:CGRectMake(20, 188, 200, 21)];
        ...
        helpHeader.frame = CGRectMake(20, 188, 200, 21);
    
    [self drawButton:CGRectMake(10, 220, 220, 45)];
    if (!helpButton)
    {
    ...
    helpButton.frame = CGRectMake(10, 220, 220, 45);
