...
- (void)viewDidLoad
{
    ...
    NSString* Coomassie = NSLocalizedString(@"Stain",@"");
    NSString* Immuno = NSLocalizedString(@"Blot",@"");
    ...
    //[segments setTitleTextAttributes:attributes
...
- (void) changeto1DPage
{
    ...
    [((UITableViewController*)masterNC.viewControllers[0]).tableView reloadSections:[NSIndexSet indexSetWithIndexesInRange:NSMakeRange (0, 2)] withRowAnimation:UITableViewRowAnimationFade];
...
- (void) viewWillDisappear:(BOOL)animated
{
    ...
    if (! app.commands.comingFromHelp)
    {
        app.commands.oneDshowing = NO;
        app.commands.twoDshowing = NO;
    ...
    else app.commands.comingFromHelp = NO;
