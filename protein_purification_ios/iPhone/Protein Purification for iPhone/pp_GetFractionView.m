...
- (void)drawRect:(CGRect)rect
{
    ...
    fractionButton.frame = CGRectMake(10, 36, 220, 180);
    ...
    if (!fractionLabel)
    {
        fractionLabel = [[UILabel alloc] initWithFrame:CGRectMake(28, 85, 120, 70)];
        ...
        fractionLabel.frame = CGRectMake(28, 85, 120, 70);
    ...
    if (!help2DButton)
    {
        ...
        [help2DButton setTitle:NSLocalizedString(@"2D - PAGE",@"").uppercaseString forState:UIControlStateNormal];
    ...
    help2DButton.frame = CGRectMake(10, 230, 220, 30);
