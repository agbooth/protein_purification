...
NSString * const CTMBannerAdActionDidBeginNotification = @"CTMBannerAdActionDidBeginNotification";
NSString * const CTMBannerAdActionDidFinishNotification = @"CTMBannerAdActionDidFinishNotification";
...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"Record",@"");
