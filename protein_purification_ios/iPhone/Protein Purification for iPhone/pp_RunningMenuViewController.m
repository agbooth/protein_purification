...
-(NSString *)tableView:(UITableView *)tableView titleForHeaderInSection:(NSInteger)section
{
    ...
    switch (section)
    {
        ...
        case 2:
            header = NSLocalizedString(@"Manage scheme",@"");
            break;
    }
    return header;
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.section)
    {
        ...
        case 0:
        {
            ...
            bool alreadyShowing = (nav.viewControllers.count == 2);
            UINavigationController* masterNC = (UINavigationController*)[app.splitViewController masterViewController];
            ...
            switch (indexPath.row)
            {
                case 0:
                    ...
                    [masterNC pushViewController: gfsvc animated:YES];
                ...
                case 1:
                    ...
                    [masterNC pushViewController: gfvc animated:YES];
