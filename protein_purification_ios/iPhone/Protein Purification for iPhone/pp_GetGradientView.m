...
- (void)drawRect:(CGRect)rect
{
    ...
    if (self.elutionpHRequired)
    {
        ...
        [self drawButton:CGRectMake(10, 36, 220, 60)];
        ...
        if (!elutionLabel)
        {
            elutionLabel = [[UILabel alloc] initWithFrame:CGRectMake(25, 40, 250, 21)];
            ...
            elutionLabel.frame = CGRectMake(25, 40, 250, 21);
        ...
        elutionPicker.center = CGPointMake(155,75);
        
        self.elutionFloatValue = 7.0;
 
    }
    // Gradient
    [self drawButton:CGRectMake(10, 36+offset, 220, 135)];
    ...
    startPicker.center = CGPointMake(155,80+offset);
    ...
    dividerButton.frame = CGRectMake(10, 103+offset, 218, 1);
    ...
    if (!endLabel)
    {
        endLabel = [[UILabel alloc] initWithFrame:CGRectMake(25, 110+offset, 250, 21)];
        ...
        endLabel.frame = CGRectMake(25, 110+offset, 250, 21);
    ...
    endPicker.center = CGPointMake(155,148+offset);
}
