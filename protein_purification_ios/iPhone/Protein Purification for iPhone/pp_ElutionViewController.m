...
@implementation pp_ElutionViewController
...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"Elution profile",@"");
...
- (void) loadView
{
    self.view = [[pp_ElutionView alloc] initWithFrame: CGRectMake(0.0,0.0, 640.0, 480.0)];
}
