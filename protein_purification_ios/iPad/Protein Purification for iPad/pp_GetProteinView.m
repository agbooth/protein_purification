...
- (void)drawRect:(CGRect)rect
{
    ...
    if (!proteinHeader)
    {
        proteinHeader = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, 280, 21)];
        ...
        proteinHeader.frame = CGRectMake(20, 10, 280, 21);
    
    if (!proteinMixture)
    {
        proteinMixture = [[UILabel alloc] initWithFrame:CGRectMake(50, 70, 220, 22)];
        ...
        proteinMixture.frame = CGRectMake(50, 70, 220, 22);
    
    if (!proteinLabel)
    {
        proteinLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 100, 220, 70)];
        ...
        proteinLabel.frame = CGRectMake(50, 100, 220, 70);
    ...
    proteinPicker.center = CGPointMake(158,200);
