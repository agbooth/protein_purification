...
- (void) Markers
{
 ...
 //   UIColor* colour = [UIColor colorWithRed:0.7734375 green:0.7734375 blue:0.7734375 alpha:1.0];
    ...
    [self create_text_in_box:@"80K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:8E4],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_text_in_box:@"60K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:6E4],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_text_in_box:@"50K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:5E4],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_text_in_box:@"40K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:4E4],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_text_in_box:@"30K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:3E4],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_line:x-12
     ...
     [self create_text_in_box:@"20K"
                         rect:CGRectMake((float)x-16.0,y+[self Mobility:2E4],1.0,18.5)
                         size:14.0
                       colour:[UIColor blackColor]
                        angle:0.0
                       italic:NO
    ...
    [self create_text_in_box:@"10K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:1E4],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_text_in_box:@"5K"
                        rect:CGRectMake((float)x-16.0,y+[self Mobility:5E3],1.0,18.5)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:NO
    ...
    [self create_text_in_box:@"r"
                        rect:CGRectMake((float)x-55.0+labelXOffset,y+[self Mobility:2E4],1.0,1.0)
                        size:14.0
                      colour:[UIColor blackColor]
                       angle:0.0
                      italic:YES
