...
- (pp_ProteinData*) init {
    ...
    self.Proteins = [[NSMutableArray alloc] init];
    self.Soluble = [[NSMutableArray alloc] init];
    self.Insoluble = [[NSMutableArray alloc] init];
...
- (void) parseData: (NSString*) fileString
{
    ...
    if (self.Proteins) self.Proteins = nil;
    ...
    for (int protein=1; protein <= self.noOfProteins; protein++) 
    {
        ...
        [self.Proteins addObject:[[pp_Protein alloc] initWithData:protein:charges:isopoint:MolWt:NoOfSub1:NoOfSub2:NoOfSub3:subunit1:subunit2:subunit3:original_amount:amount:temp:pH1:pH2:sulphate:original_activity:activity]];
