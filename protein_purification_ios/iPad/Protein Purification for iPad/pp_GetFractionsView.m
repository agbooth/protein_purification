...
- (void) drawRoundRect
{
    ...
    CGContextSetStrokeColorWithColor(con, [UIColor grayColor].CGColor);
    CGContextSetFillColorWithColor(con, [UIColor whiteColor].CGColor);
    UIBezierPath* path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(10, 36, 300, 210) cornerRadius:10.0];
    [path fill];
    path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(10, 36, 300, 208) cornerRadius:10.0];
    [path fill];
    [path stroke];
    CGContextRestoreGState(con);
...
- (void)drawRect:(CGRect)rect
{
    ...
    [self drawButton:CGRectMake(10, 36, 300, 210)];
    ...
    if (!fractionNote)
    {
        fractionNote = [[UILabel alloc] initWithFrame:CGRectMake(42, 50, 150, 70)];
        ...
        fractionNote.frame = CGRectMake(42, 50, 150, 70);
    ...
    if (!help1DHeader)
    {
        help1DHeader = [[UILabel alloc] initWithFrame:CGRectMake(20, 278, 250, 21)];
        help1DHeader.font = [UIFont fontWithName:@"Helvetica" size:13.0];
        help1DHeader.text = NSLocalizedString(@"Information",@"").uppercaseString;
        help1DHeader.shadowOffset = CGSizeMake(0.0,0.5);
        help1DHeader.textColor = [UIColor colorWithRed:76.0/256.0 green:86.0/256.0 blue:108.0/256.0 alpha:1.0];
        help1DHeader.shadowColor = [UIColor whiteColor];
        
        help1DHeader.backgroundColor = [UIColor clearColor];
        [self addSubview:help1DHeader];
    }
    else
        help1DHeader.frame = CGRectMake(20, 278, 250, 21);
    ...
    if (!help1DButton)
    {
        ...
        [help1DButton setTitle:NSLocalizedString(@"1D - PAGE",@"") forState:UIControlStateNormal];
    ...
    help1DButton.frame = CGRectMake(10, 310, 300, 45);
