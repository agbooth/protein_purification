...
{
    //NSLog(@"app.commands.comingFromHelp = %d", app.commands.comingFromHelp);
    //NSLog(@"app.commands.twoDshowing = %d", app.commands.twoDshowing);
    //NSLog(@"app.commands.oneDshowing = %d", app.commands.oneDshowing);
        ...
        case 2:
             switch (indexPath.row)
            {
                ...
                case 1:
                {
                    ...
                    alert2 = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Store material",@"")
                                                        message:NSLocalizedString(@"Please enter a unique name for the stored material.",@"")
                                                       delegate:self
                                              cancelButtonTitle:NSLocalizedString(@"OK",@"")
