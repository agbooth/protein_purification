...
- (void)drawRect:(CGRect)rect
{
    ...
    if (!ammsulfHeader)
    {
            ammsulfHeader = [[UILabel alloc] initWithFrame:CGRectMake(20, 10, 250, 21)];
        ...
        ammsulfHeader.frame = CGRectMake(20, 10, 250, 21);
        
    if (!ammsulfLabel)
    {
            ammsulfLabel = [[UILabel alloc] initWithFrame:CGRectMake(25, 42, 250, 21)];
        ...
        ammsulfLabel.frame = CGRectMake(25, 42, 250, 21);
    ...
    if (!helpHeader)
    {
        helpHeader = [[UILabel alloc] initWithFrame:CGRectMake(20, 148, 250, 21)];
        ...
        helpHeader.frame = CGRectMake(20, 148, 250, 21);
    
    [self drawButton:CGRectMake(10, 180, 300, 45)];
    ...
    helpButton.frame = CGRectMake(10, 180, 300, 45);                                                
